...
class TestImageList:
    ...
    def test_list_images_authenticated(
        self, authenticated_client, user, create_medical_image, sample_image
    ):
    ...
    def test_list_images_only_user_images(
        self,
...
class TestImageUpload:
    ...
    def test_upload_image_unauthenticated(self, api_client, sample_image):
        ...
        url = reverse("images-list")
        data = {"title": "Test Scan", "image": sample_image}
...
class TestImageDetail:
    ...
    def test_get_image_detail(
        self, authenticated_client, create_medical_image, user, sample_image
    ):
    ...
    def test_get_other_user_image(
        self, authenticated_client, create_user, create_medical_image, sample_image
    ):
        """Test accessing another user's image"""
        other_user = create_user(email="other@example.com")
        image = create_medical_image(
            user=other_user, title="Other Image", image=sample_image
        )
        url = reverse("images-detail", kwargs={"pk": image.id})
...
class TestImageUpdate:
    ...
    def test_update_image(
        ...
        image = create_medical_image(
            user=user, title="Original Title", image=sample_image
        )
        url = reverse("images-detail", kwargs={"pk": image.id})
    ...
    def test_update_other_user_image(
        self, authenticated_client, create_user, create_medical_image, sample_image
    ):
...
class TestImageAnalysis:
    ...
    def test_start_analysis_already_analyzed(
        self, authenticated_client, create_medical_image, user, sample_image
    ):
    ...
    def test_start_analysis_other_user_image(
        self, authenticated_client, create_user, create_medical_image, sample_image
    ):
