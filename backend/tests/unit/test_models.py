...
class TestMedicalImageModel:
    ...
    def test_medical_image_str_representation(self, create_medical_image, user, sample_image):
    ...
    def test_medical_image_analysis_started(self, create_medical_image, user, sample_image):
    ...
    def test_medical_image_analyzed_flag(self, create_medical_image, user, sample_image):
        """Test analyzed flag"""
        image = create_medical_image(user=user, title='Test', image=sample_image)
...
class TestAnalysisModel:
    ...
    def test_analysis_str_representation(self, create_medical_image, user, sample_image):
    ...
    def test_analysis_one_to_one_relationship(self, create_medical_image, user, sample_image):
    ...
    def test_analysis_ordering(self, user, sample_image):
        ...
        image1 = MedicalImage.objects.create(user=user, title='Image 1', image=sample_image)
        analysis1 = Analysis.objects.create(image=image1)

        time.sleep(0.1)

        image2 = MedicalImage.objects.create(user=user, title='Image 2', image=sample_image)
